...
class Ffvae_cfair(nn.Module):
    ...
    def __init__(self, args):
        ...
        # Cfair Discriminator
        self.num_classes = args.num_classes
        self.discriminator_cfair = nn.ModuleList(
            [MLP_cfair(self.adv_neurons) for _ in range(self.num_classes)])
    ...
    def vae_params(self):
        ...
        if self.data == "clr-mnist":
            ...
            return list(self.encoder.parameters()) + list(self.decoder.parameters()) + list(self.discriminator_cfair.parameters())

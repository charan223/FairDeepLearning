...
def add_model_args(parser):
    ...
    add_argument(parser, '--d-coeff', type=float, default=10.,
                 help='(default: 10.)')
    add_argument(parser, '--which_class', type=str, choices=['0', '1'], default=0,
                 help='indicates the class to train the discriminator for equality of Opp')
...
def add_shared_args(parser):
    ...
    add_argument(parser, '--measure_sensattr', default='bck', type=str,
                 help='sensitive attribute to measure metrics on')
    ...
    add_argument(parser, '--green_1', default=0, type=int,
                 help='green_1 val')
    add_argument(parser, '--green_2', action='store_true', default=False,
                 help='green_2 bool val')
    add_argument(parser, '--gw', default=0, type=int,
                 help='green width')
    add_argument(parser, '--digit_pattern', default=0, type=int,
                 help='digit pattern')
    add_argument(parser, '--epr', default=0, type=float,
                 help='epr')
    add_argument(parser, '--opr', default=0, type=float,
                 help='opr')
    ...
    add_argument(parser, '--hpid', type=int, default=None,
                 help='Hyperparameter ID (default: None)')
    ...
    add_argument(parser, '--n_attr', type=int, default=2,
                 help='Attributes to classify (default: 2)')
    ...
    add_argument(parser, '--label_type', default='even-odd', type=str,
                 help='label type')
    add_argument(parser, '--batchnorm', default=True, type=bool,
                 help='batch norm')
    ...
    # add_argument(parser, '--ifwandb', default=False, type=bool,
...
def parse_args(input_args=None, parse_known=False):
    parser = argparse.ArgumentParser(
        description='MNIST Odd-Even Binary Classification Example')
